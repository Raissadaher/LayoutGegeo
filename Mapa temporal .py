...
mapa01.grid().setGridLineWidth(0.025)
...
cor_do_grid = QColor(0, 0, 0, 10)  # 128 é a opacidade (0 a 255)
...
mapa02.grid().setGridLineWidth(0.025)
...
mapa03.grid().setGridLineWidth(0.025)
...
mapa04.grid().setGridLineWidth(0.025)
